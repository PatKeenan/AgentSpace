    ...
    >
      {Icon && iconPosition == "left" && (
        <Icon
          className={clsx(
            ...
            hideChildrenOnMobile ? "lg:-ml-1 lg:mr-2" : "-ml-1 mr-2",
            variant == "primary" && actionIcon !== "delete" && "text-white",
            actionIcon == "delete" ? "text-red-400" : "text-gray-400"
          )}
          aria-hidden
        />
      )}
      ...
      {Icon && iconPosition == "right" && (
        <Icon
          className={clsx(
            iconSizeOptions[iconSize],
            hideChildrenOnMobile ? "lg:-mr-1 lg:ml-2" : "-mr-1 ml-2",
            variant == "primary" && actionIcon !== "delete" && "text-white",
            actionIcon == "delete" ? "text-red-400" : "text-gray-400"
          )}
          aria-hidden
...
export const ButtonLink = (props: ButtonLinkProps) => {
  ...
  return (
    ...
    >
      ...
      <span className={clsx(Icon && hideChildrenOnMobile && "hidden lg:block")}>
        {children}
      </span>
      {Icon && iconPosition == "right" && (
        <Icon
    ...
    >
      ...
      <Icon
        className={clsx(
          ...
          textColor ? textColor : "text-gray-300 group-hover:text-gray-400"
        )}
        aria-hidden="true"
      />
    </button>
