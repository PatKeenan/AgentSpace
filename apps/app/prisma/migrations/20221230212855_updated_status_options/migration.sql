...
-- AlterEnum
BEGIN;
CREATE TYPE "AppointmentStatus_new" AS ENUM ('NO_STATUS', 'CONFIRMED', 'CANCELED', 'PENDING', 'DENIED');
...
ALTER TABLE "Appointment" ALTER COLUMN "status" SET DEFAULT 'NO_STATUS';
COMMIT;
