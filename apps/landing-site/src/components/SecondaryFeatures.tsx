...
import screenshotDashboard from "images/dashboard.png";
import screenshotContacts from "images/contact-detail.png";
import screenshotAppointments from "images/appointments.png";
import screenshotTasks from "images/tasks.png";
...
function Feature({
    ...
    feature: Omit<FeaturesType[number], "name"> & {
